...
def generate_launch_description():
    ...
    config = os.path.join(get_package_share_directory('neo_mpo_500'),'configs/lidar/sick/s300','s300_1.yaml')
    config1 = os.path.join(get_package_share_directory('neo_mpo_500'),'configs/lidar/sick/s300','s300_filter_1.yaml')
    config2 = os.path.join(get_package_share_directory('neo_mpo_500'),'configs/lidar/sick/s300','s300_2.yaml')
    config3 = os.path.join(get_package_share_directory('neo_mpo_500'),'configs/lidar/sick/s300','s300_filter_2.yaml')
